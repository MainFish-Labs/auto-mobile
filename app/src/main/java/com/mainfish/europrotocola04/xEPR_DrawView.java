 ...
 */
public class xEPR_DrawView extends View {
    ...
    public xEPR_DrawView(Context context) {
    ...
    public xEPR_DrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public xEPR_DrawView(Context context, AttributeSet attrs, int defStyleAttr) {
