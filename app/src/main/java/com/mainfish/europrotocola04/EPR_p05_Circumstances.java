    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        switch_a_1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Не соблюдал безопасную дистанцию" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Не соблюдал необходимый боковой интервал" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Перестраивался в другую полосу" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Поворачивал направо" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Поворачивал налево" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Разворачивался" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_7.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Двигался задним ходом" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_8.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Съезжал с проезжей части дороги" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_9.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Выехал на перекресток на запрещающий сигнал светофора" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_10.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Выехал на полосу встречного движения" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_11.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Нарушил правила обгона" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_12.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Начинал движение после остановки, стоянки" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_13.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Не выполнил требования знака приоритета" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_14.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Выезжал со второстепенной дороги, прилегающей территории" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_15.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Двигался по прилегающей территории при наличии препятствия справа" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_16.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Двигался по перекрестку с круговым движением" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_17.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Совершил наезд на стоящее ТС" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
        ...
        switch_a_18.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Toast.makeText(EPR_p05_Circumstances.this, "Иное нарушение, неуказанное в подпунктах 1–17" + ".\nВодитель ТС А - " + (isChecked ? "Да" : "Нет"),Toast.LENGTH_SHORT).show();
